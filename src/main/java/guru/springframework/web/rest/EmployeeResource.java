...
import guru.springframework.web.rest.errors.BadRequestAlertException;
...
public class EmployeeResource {
    ...
    public ResponseEntity<EmployeeDTO> createEmployee(@RequestBody EmployeeDTO employeeDTO) throws URISyntaxException {
        ...
        if (employeeDTO.getId() != null) {
            throw new BadRequestAlertException("A new employee cannot already have an ID", ENTITY_NAME, "id exists");
        }
    ...
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(Pageable pageable) {
        ...
        HttpHeaders headers;
        try {
            headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/employees");
        } catch (URISyntaxException e) {
            throw new BadRequestAlertException("A new country cannot already have an ID", ENTITY_NAME, "id exists");
        }
